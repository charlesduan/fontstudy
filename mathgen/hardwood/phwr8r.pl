(COMMENT font phwr8r created by fontinst v1.801)

(COMMENT Filename: phwr8r.pl)
(COMMENT Created by: tex texput)
(COMMENT Created using: \etxtopl{8r}{phwr8r})

(COMMENT This file can be turned into a fontwith)
(COMMENT pltotfm phwr8r.pl phwr8r.tfm)
